...
export default {
  ...
  socials: [{
    ...
    link: "https://linkedin.com/in/jonorsi/",
    title: "LinkedIn",
  }, {
    icon: (
      <svg
    ...
    link: "mailto:jonathon.orsi@gmail.com",
    title: "Mail",
  }, {
    icon: (
      <svg
    ...
    link:
      "https://open.spotify.com/artist/1tSaSVwi5i2ZJfOYbomSnM?si=V8xOCbx9SqevI-TWEQsn_w",
    title: "Spotify",
  }],
  works: [{
    description: (
    ...
    description: (
      <p>
        Web application port of the flash player{" "}
        <a href="https://www.wmarksutherland.com/code-x">
          Code X created by W. Mark Sutherland
