                ...
                <div className="container">
                            ...
                            <div className="column w-m-50">
                                <div className="project__picture__container">
                                    <img src={imageHumbleRootsMedia}
                                        ...
                                        className="project__picture project__picture-left" />
                                </div>
                            </div>
                            <div className="column w-m-50">
                    ...
                    <div className="project-item">
                        ...
                        <div className="row">
                            ...
                            <div className="column w-m-50">
                                <div className="project__picture__container">
                                    <img className="project__picture project__picture-right" alt="zenHTML" src={imageZenHtml} />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="project-item">
                        ...
                        <div className="row">
                            <div className="column w-m-50">
                                <div className="project__picture__container">
                                    <img className="project__picture project__picture-left" alt="Reverie" src={imageReverie} />
                                </div>
                            </div>
                            <div className="column w-m-50">
